...
void ULabyrinthDamageGameplayAbility::CauseDamage(AActor* TargetActor)
{
...
FDamageEffectParams ULabyrinthDamageGameplayAbility::MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor,
...
float ULabyrinthDamageGameplayAbility::GetDamageAtLevel() const
{
	return Damage.GetValueAtLevel(GetAbilityLevel());
}

FTaggedMontage ULabyrinthDamageGameplayAbility::GetRandomTaggedMontageFromArray(const TArray<FTaggedMontage>& TaggedMontages) const
{
